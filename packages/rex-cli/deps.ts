...
export { existsSync, exists } from "https://deno.land/std/fs/exists.ts";
export { walk, walkSync } from "https://deno.land/std/fs/walk.ts";
export type { WalkEntry } from "https://deno.land/std/fs/walk.ts";
export { globToRegExp } from "https://deno.land/std/path/glob_to_regexp.ts";
export { SEPARATOR } from "https://deno.land/std/path/constants.ts";
export { normalizeGlob } from "https://deno.land/std/path/normalize_glob.ts";
export {
  RexError,
  RexConfigFile,
  RexFile,
